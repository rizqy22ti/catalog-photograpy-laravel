  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex justify-between items-center py-5 md:justify-start md:space-x-10">
      <div class="flex justify-start lg:w-0 lg:flex-1">
        <a href="/" class="text-xl font-black text-indigo-600">CatalogPhoto</a>
      </div>
      ...
      <nav class="hidden md:flex space-x-10">
        ...
        @auth
          <a href="/dashboard/posts" class="text-base font-medium text-gray-500 hover:text-gray-900"> Dashboard </a>
        @endauth
      </nav>
